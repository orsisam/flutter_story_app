...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CreateStoryEvent);
}
...
/// @nodoc
class $CreateStoryEventCopyWith<$Res>  {
$CreateStoryEventCopyWith(CreateStoryEvent _, $Res Function(CreateStoryEvent) __);
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  started,TResult Function( String title,  String content,  File? image)?  create,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Started() when started != null:
return started();case _Create() when create != null:
return create(_that.title,_that.content,_that.image);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  started,required TResult Function( String title,  String content,  File? image)  create,}) {final _that = this;
switch (_that) {
case _Started():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  started,TResult? Function( String title,  String content,  File? image)?  create,}) {final _that = this;
switch (_that) {
case _Started() when started != null:
return started();case _Create() when create != null:
return create(_that.title,_that.content,_that.image);case _:
...
class _Started implements CreateStoryEvent {
  const _Started();
...
@override
String toString() {
  return 'CreateStoryEvent.started()';
}
...
class _Create implements CreateStoryEvent {
  const _Create({required this.title, required this.content, this.image});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Create&&(identical(other.title, title) || other.title == title)&&(identical(other.content, content) || other.content == content)&&(identical(other.image, image) || other.image == image));
}
...
@override
String toString() {
  return 'CreateStoryEvent.create(title: $title, content: $content, image: $image)';
}
...
/// @nodoc
abstract mixin class _$CreateCopyWith<$Res> implements $CreateStoryEventCopyWith<$Res> {
...
/// Create a copy of CreateStoryEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? title = null,Object? content = null,Object? image = freezed,}) {
