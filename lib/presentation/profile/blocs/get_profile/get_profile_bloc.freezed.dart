...
class _GetProfile implements GetProfileEvent {
  const _GetProfile();
...
class _Loading implements GetProfileState {
  const _Loading();
...
class _Success implements GetProfileState {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Success&&const DeepCollectionEquality().equals(other.user, user));
}
...
@override
String toString() {
  return 'GetProfileState.success(user: $user)';
}
...
/// @nodoc
abstract mixin class _$SuccessCopyWith<$Res> implements $GetProfileStateCopyWith<$Res> {
...
class _Error implements GetProfileState {
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $GetProfileStateCopyWith<$Res> {
